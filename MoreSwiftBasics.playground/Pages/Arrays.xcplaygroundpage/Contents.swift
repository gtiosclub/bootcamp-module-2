...
//Yes, there is no index '4' in a 4-element array, there are 4 elements but no index '4', there is only index 0-3. To fix this we need to access index '3' which accesses the 4th element in the 4-element array
